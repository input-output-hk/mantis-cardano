...
object BlockchainTestConfig {
  val BaseConfig = BlockchainConfig(
  ...
  val FrontierConfig = BaseConfig.copy(frontierBlockNumber = 0)

  val HomesteadConfig = BaseConfig.copy(
     frontierBlockNumber = -1,
     homesteadBlockNumber = 0
  )

  val Eip150Config = BaseConfig.copy(
     frontierBlockNumber = -1,
     homesteadBlockNumber = -1,
     eip150BlockNumber = 0
  )

  val FrontierToHomesteadAt5 = BaseConfig.copy(
     frontierBlockNumber = 0,
     homesteadBlockNumber = 5
  )

  val HomesteadToEIP150At5 = BaseConfig.copy(
     frontierBlockNumber = -1,
     homesteadBlockNumber = 0,
     eip150BlockNumber = 5
  )

  val HomesteadToDaoAt5 = BaseConfig.copy(
     frontierBlockNumber = -1,
     homesteadBlockNumber = 0,
     daoForkConfig = Some(
      new DaoForkConfig {
  ...
  val Eip158Config = BaseConfig.copy(
     frontierBlockNumber = -1,
     homesteadBlockNumber = -1,
     eip150BlockNumber = -1,
     eip155BlockNumber = -1,
