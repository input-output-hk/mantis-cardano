...
class JsonRpcWebsocketServer(jsonRpcController: JsonRpcController, appStateStorage: AppStateStorage,
                             blockchain: Blockchain, config: JsonRpcWebsocketServerConfig)
